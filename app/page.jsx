  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center px-6 sm:px-10 lg:px-16 bg-parchment text-ink">
      <section className="flex-1 flex flex-col items-center justify-center text-center max-w-4xl mx-auto py-24">
        ...
        <p className="fade-in-delay-1 mt-10 sm:mt-12 max-w-2xl text-sm sm:text-base md:text-lg font-light leading-relaxed tracking-wide text-muted">
          A boutique advisory firm providing management consulting,
          go-to-market strategy, public policy advisory, leadership coaching,
